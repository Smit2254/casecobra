...
const DesignConfigurator = ({ configId, imageUrl, imageDimensions }: DesignConfiguratorProps) => {
  ...
  return (
    <div className='relative mt-20 grid grid-cols-3 lg:grid-cols-3 mb-20 pb-20'>
      <div
        ref={containerRef}
        className='relative overflow-hidden h-[37.5rem] col-span-2 w-full max-w-4xl flex items-center justify-center rounded-lg border-2 border-dashed border-gray-300 p-12 text-center focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2'
      >
                    ...
                    <div className='mt-3 space-y-4'>
                      {selectableOptions.map((option) => (
                        ...
                        >
                          ...
                          >
                            <span className='font-medium text-gray-900'>{formatePrice(option.price / 100)}</span>
                          </RadioGroup.Description>
                        </RadioGroup.Option>
                      ))}
                    </div>
